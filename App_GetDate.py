...
class web_server:
    ...
    def getResult(self):  # 呼叫OCR API
        ...
        date_check_list=answer['ocr_txt']
        #print(date_check_list)
        #print(type(date_check_list))
        checked_list = TimeFormatCheck.get_result(date_check_list)
        answer["date_txt"] = checked_list
        # change status
        self.status = "free"
        return answer
